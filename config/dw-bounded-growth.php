...
return [
    ...
    'cache_keys' => [
        ...
        'readiness_probe' => [
            ...
            'ttl' => '10 seconds.',
            'bound' => 'At most two temporary keys per /api/ready request when both Redis queue and cache are configured; keys use random probe IDs and are not indexed.',
            'admission' => 'Readiness writes only during a probe request; bootstrap admission does not probe Redis.',
