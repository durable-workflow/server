...
return [
    ...
    'cache_keys' => [
        ...
        'task_queue_admission_locks' => [
            ...
            'dimensions' => [
                'namespace_hash',
                'task_queue_hash_or_namespace_scope',
                'task_kind',
            ],
            'ttl' => 'server.admission.lock_ttl_seconds seconds, default 5.',
            'bound' => 'One short-lived lock key per namespace/task_queue/task_kind with queue-level caps, or per namespace/task_kind when namespace-wide caps are configured and concurrent poll attempts exist.',
        ...
        'task_queue_dispatch_counters' => [
            ...
            'ttl' => '2 minutes.',
            'bound' => 'One short-lived counter per capped namespace/task_queue/task_kind/minute bucket, plus one namespace/task_kind/minute counter for namespace-wide dispatch budgets, when at least one task is leased.',
