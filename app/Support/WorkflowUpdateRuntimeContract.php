            ...
            'host_runner_contract' => [
                ...
                'typed_coverage_gaps' => [
                    'operator_diagnostics_surfaces' => [
                        ...
                        'owner' => 'waterline',
                        'acceptance' => 'Capture workflow update fields from the official CLI JSON output and Waterline selected-run update/history surfaces for accepted, completed, failed, and refused updates.',
                    ],
                ],
