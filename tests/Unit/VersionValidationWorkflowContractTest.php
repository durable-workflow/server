...
{
    public function test_validation_workflow_uses_the_synchronized_beta_14_product_train(): void
    {
        ...
        $this->assertSame([
            ...
            'PYTHON_SDK_VERSION' => '2.0.0b14',
        ], $job['env'] ?? null);

        $server = $this->step($job, 'Start beta.14 server');
