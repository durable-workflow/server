...
{
    public function test_validation_workflow_uses_beta_21_server_with_beta_21_clients(): void
    {
        ...
        $this->assertSame([
            ...
            'PYTHON_SDK_VERSION' => '2.0.0b21',
        ], $job['env'] ?? null);

        $server = $this->step($job, 'Start beta.21 server');
