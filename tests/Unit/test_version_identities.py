...
class PublishedVersionIdentitiesTest(unittest.TestCase):
    def test_exact_server_release_identities(self) -> None:
        for version in ("2.0.0-alpha.1", "2.0.0-beta.11", "2.0.0-rc.2", "2.0.0"):
    ...
    def test_pep440_and_semver_python_release_identity(self) -> None:
        ...
        self.assertEqual("2.0.0b11", python_release_identity("2.0.0-beta.11"))
        self.assertEqual("2.0.0rc2", python_release_identity("2.0.0-rc.2"))
        self.assertTrue(same_python_release("2.0.0-beta.11", "2.0.0b11"))
        self.assertFalse(same_python_release("2.0.0-beta.11", "2.0.0b3"))
