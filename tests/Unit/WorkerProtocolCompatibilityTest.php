...
class WorkerProtocolCompatibilityTest extends TestCase
{
    ...
    public static function compatibilityCases(): array
    {
        return [
            ...
            'current published PHP worker protocol accepted' => ['worker' => '1.8', 'server' => WorkerProtocol::VERSION, 'expected' => true],
            'previous minor accepted' => ['worker' => '1.7', 'server' => WorkerProtocol::VERSION, 'expected' => true],
