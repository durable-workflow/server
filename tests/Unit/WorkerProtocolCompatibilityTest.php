...
class WorkerProtocolCompatibilityTest extends TestCase
{
    ...
    public static function compatibilityCases(): array
    {
        return [
            ...
            'previous published PHP worker protocol accepted' => ['worker' => '1.12', 'server' => WorkerProtocol::VERSION, 'expected' => true],
            ...
            'worker ahead of current server rejected' => ['worker' => '1.14', 'server' => WorkerProtocol::VERSION, 'expected' => false],
