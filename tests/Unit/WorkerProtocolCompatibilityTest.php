...
class WorkerProtocolCompatibilityTest extends TestCase
{
    ...
    public static function compatibilityCases(): array
    {
        return [
            ...
            'previous published PHP worker protocol accepted' => ['worker' => '1.11', 'server' => WorkerProtocol::VERSION, 'expected' => true],
            'previous minor accepted' => ['worker' => '1.10', 'server' => WorkerProtocol::VERSION, 'expected' => true],
