...
class ReleaseImagePublishWorkflowContractTest extends TestCase
{
    ...
    public function test_dockerfile_refreshes_composer_metadata_for_selected_workflow_package(): void
    {
        ...
        foreach ([
            'ARG WORKFLOW_PACKAGE_REF=2.0.0-beta.16',
            'ARG WORKFLOW_PACKAGE_COMMIT=68262eb8589e8e1142c2e158f50815950a347ef8',
    ...
    {
        $commit = '68262eb8589e8e1142c2e158f50815950a347ef8';
        $dockerfile = $this->read('Dockerfile');
    ...
    public function test_feature_ci_verifies_the_exact_workflow_source_before_removing_git_metadata(): void
    {
        ...
        foreach ([
            'ref: 68262eb8589e8e1142c2e158f50815950a347ef8',
            'WORKFLOW_PACKAGE_REF: 2.0.0-beta.16',
            'WORKFLOW_PACKAGE_COMMIT: 68262eb8589e8e1142c2e158f50815950a347ef8',
    ...
    public function test_release_workflow_pins_the_selected_workflow_ref_and_commit(): void
    {
        ...
        $this->assertStringContainsString('WORKFLOW_PACKAGE_REF: 2.0.0-beta.16', $workflow);
        $this->assertStringContainsString(
            'WORKFLOW_PACKAGE_COMMIT: 68262eb8589e8e1142c2e158f50815950a347ef8',
            $workflow,
        );
...
SH);
    ...
    public function test_composer_metadata_identifies_the_exact_workflow_source(): void
    {
        ...
        $expectedCommit = '68262eb8589e8e1142c2e158f50815950a347ef8';
    ...
    public function test_release_protocol_catalog_comparator_rejects_stale_provenance_and_catalog_drift(): void
    {
        ...
        $this->assertNotEmpty(array_filter(
            ...
            static fn (array $finding): bool => ($finding['kind'] ?? null) === 'workflow_package_provenance_mismatch'
                ...
                && ($finding['expected'] ?? null) === '2.0.0-beta.16'
                && ($finding['actual'] ?? null) === '2.0.0-alpha.291',
        ));
        $this->assertStringContainsString(
            'Workflow package provenance ref expected "2.0.0-beta.16", got "2.0.0-alpha.291".',
            $stale['stderr'],
        );
