...
class ReleaseImagePublishWorkflowContractTest extends TestCase
{
    ...
    public function test_dockerfile_refreshes_composer_metadata_for_selected_workflow_package(): void
    {
        ...
        foreach ([
            'ARG WORKFLOW_PACKAGE_REF=2.0.0-alpha.258',
            'ARG WORKFLOW_PACKAGE_COMMIT=70ac7d56d392ffe14cee01ba41eedeb683d3b976',
    ...
    {
        $fallback = '2.0.0-alpha.258';
        $commit = '70ac7d56d392ffe14cee01ba41eedeb683d3b976';
        ...
        $this->assertStringContainsString('WORKFLOW_PACKAGE_REF=2.0.0-alpha.258', $readme);
        $this->assertStringContainsString('The Dockerfile clones the `durable-workflow/workflow` `2.0.0-alpha.258` tag', $readme);
